...
// Ambil data menu milik user yang sedang login dengan jenis "Makanan"
$stmt = $conn->prepare("SELECT id, gambar, nama, jenis 
                        FROM menu 
                        WHERE user_id = ? AND jenis = 'Makanan' 
...
<div class="container my-5">
  <h2 class="text-center fw-bold display-5 mb-4">Daftar Menu Makanan</h2>
  ...
  <?php if ($result): ?>
    ...
    <?php else: ?>
      <div class="alert alert-info text-center">Belum ada menu makanan yang ditambahkan oleh Anda.</div>
    <?php endif; ?>
  <?php else: ?>
